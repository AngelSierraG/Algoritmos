...
public class RedBlackTree<E> implements Iterable<Key<E>>
{
  ...
  */
  public void findAll(Key k, List<Key<E>> lst)
  {
    if ( size == 0 ) return;
  ...
  public boolean member(Key k){ return find(k) != null; }
