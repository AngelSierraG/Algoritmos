...
public class Key<D>
{
  ...
  /**
   * This is optional satalite data to associate with the key.
   */
  protected D data;
  ...
  */
  public Key(Key k, D o) { this(k.value, o); }

  public Key(Key k) { this(k.value); }
   ...
   */
  public Key<D> compose(D o, Key k)
  {
  ...
  */
   ...
   */
  public static int cmp(Key k1, Key k2)
  {
  ...
  public boolean ne (Key k) { return cmp(this, k) != 0; }

  /** Are <i>this</i> and k equal? */
  public boolean eq (Key k) { return cmp(this, k) == 0; }

  /** Is <i>this</i> less than or equal to k? */
  public boolean lte(Key k) { return cmp(this, k) <= 0; }

  /** Is <i>this</i> less than k? */
  public boolean lt (Key k) { return cmp(this, k) <  0; }

  /** Is <i>this</i> greater than or equal to k? */
  public boolean gte(Key k) { return cmp(this, k) >= 0; }

  /** Is <i>this</i> greater than k? */
  public boolean gt (Key k) { return cmp(this, k) >  0; }
